...
#Region "Chargement grille"
    ...
    Private m_i_nom_mutu As Integer
    Private m_i_prenom_mutu As Integer
    ...
    Private Sub grdtestmutu_Init(sender As Object, e As EventArgs) Handles grdtestmutu.Init
        With grdtestmutu
            ...
            With .AddButtonColumn()
                ...
                .Target = "tabrembrst" + VTL_REMBOURSMT.VTL_REMBOURSMT_ID
            ...
            End With
            With .AddNumericColumn("Taux de remboursement", VTL_CONTRAT.VTL_CONTRAT_TXREMB)
                m_i_txremb_mutu = .ColumnIndex
            End With
            With .AddNumericColumn("Montant", VTL_REMBOURSMT.VTL_REMBOURSMT_MONTANT)
                m_i_montant = .ColumnIndex
            End With
            With .AddColumn("Nom client", VTL_PROPRIETAIRE.VTL_PROPRIETAIRE_NOM)
                m_i_nom_mutu = .ColumnIndex
            End With
            With .AddColumn("Prénom client", VTL_PROPRIETAIRE.VTL_PROPRIETAIRE_PRENOM)
                m_i_prenom_mutu = .ColumnIndex
            End With

...
Partial Public Class PageHistoConsul
    ...
    '''<summary>
    '''Contrôle frmLastConsul.
    '''</summary>
    '''<remarks>
    '''Champ généré automatiquement.
    '''Pour modifier, déplacez la déclaration de champ du fichier de concepteur dans le fichier code-behind.
    '''</remarks>
    Protected WithEvents frmLastConsul As Global.Corail.Web.CwFrame
    ...
    '''Pour modifier, déplacez la déclaration de champ du fichier de concepteur dans le fichier code-behind.
    '''</remarks>
    Protected WithEvents dtbConsul As Global.Corail.Web.CwDateTextBox
    ...
    '''Pour modifier, déplacez la déclaration de champ du fichier de concepteur dans le fichier code-behind.
    '''</remarks>
    Protected WithEvents txtComm As Global.Corail.Web.CwTextBox

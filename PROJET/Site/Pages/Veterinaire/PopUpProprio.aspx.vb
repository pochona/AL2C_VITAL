...
#Region "Grille"
    ...
    'x     Private Sub dtgProprio_DataTableRequest(sender As Object, ByRef p_o_dt As DataTable, e As EventArgs) Handles dtgProprio.DataTableRequest
    'x         Try
    'x             p_o_dt = PropriEtaire.GetAll.GetDT
    'x         Catch ex As Exception
    'x             ShowException(ex)
    'x         End Try
    'x     End Sub
    'x 
    'x     Private Sub dtgProprio_Init(sender As Object, e As EventArgs) Handles dtgProprio.Init
    'x         With dtgProprio
    'x             .DataKeyField = VTL_PROPRIETAIRE.VTL_PROPRIETAIRE_ID
    'x 
    'x             With .AddSelectColumn("Nom", VTL_PROPRIETAIRE.VTL_PROPRIETAIRE_NOM, "=")
    'x                 ' On revoie le champ
    'x                 .AddReturnedFields(VTL_PROPRIETAIRE.VTL_PROPRIETAIRE_ID)
    'x                 ' Taille 
    'x                 .Width = Unit.Pixel(65)
    'x             End With
    'x             .AddColumn("Prénom", VTL_PROPRIETAIRE.VTL_PROPRIETAIRE_PRENOM)
    'x             .AddColumn("Adresse", VTL_PROPRIETAIRE.VTL_PROPRIETAIRE_ADR)
    'x             .AddColumn("Code Postal", VTL_PROPRIETAIRE.VTL_PROPRIETAIRE_CP)
    'x             .AddColumn("Ville", VTL_PROPRIETAIRE.VTL_PROPRIETAIRE_VILLE)
    'x             .AddColumn("Téléphone", VTL_PROPRIETAIRE.VTL_PROPRIETAIRE_TEL)
    'x             .AddColumn("Mail", VTL_PROPRIETAIRE.VTL_PROPRIETAIRE_MAIL)
    'x         End With
    'x     End Sub

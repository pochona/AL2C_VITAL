...
#Region "Méthodes publiques"
        ...
        Public Overridable Sub Save(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            l_o_qry.AddTypedValue(VITAL.VITAL_ANIMALDOCS.ANIMALDOCS_ID_ANIMAL, Id_Animal)
...
#Region "Méthodes publiques"
        ...
        Public Overridable Sub Save(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            l_o_qry.AddValue(VITAL.VTL_ANIMAL.VTL_ANIMAL_IMAGE, StrToBlob(Image))
...
#Region "Attachement - Attachement"
    ...
    <Serializable()> _
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Modeler", "1.4")> _
    Public MustInherit Class Attachement
        Inherits Raw.Attachement(Of VITAL.Attachement)
...
#Region "Méthodes publiques"
        ...
        Public Shared Function GetAll(Optional p_o_trans As Transaction = Nothing) As Query
            ...
            l_o_qry.AddFrom(Tables.VTL_ATTACHEMT)
            Return l_o_qry
        End Function
        ...
        Friend Shared Function FindDR(p_i_iD As Integer, Optional p_o_trans As Transaction = Nothing) As DataRow
            ...
            Else
                Dim l_o_qry As Query = GetAll(p_o_trans)
                l_o_qry.AddWhereIs(VITAL.VTL_ATTACHEMT.VTL_ATTACHEMT_ID, p_i_iD)
                Return l_o_qry.GetFirstRow()
            End If
        End Function

        ''' <summary>
        ''' Chargement des informations à partir la table VTL_ATTACHEMT.
        ''' </summary>
        ''' <param name="p_i_iD">ID.</param>
        ''' <param name="p_o_trans">Transaction à utiliser.</param>
        Public Overloads Sub Load(p_i_iD As Integer, Optional p_o_trans As Transaction = Nothing)
        ...
        ''' <summary>
        ''' Chargement des informations à partir de la table VTL_ATTACHEMT.
        ''' </summary>
        ''' <param name="p_o_row">Enregistrement.</param>
        Public Overrides Sub Load(p_o_row As DataRow)
            MyBase.Load(p_o_row)
        ...
        ''' <summary>
        ''' Enregistrer les informations dans la table VTL_ATTACHEMT.
        ''' </summary>
        ''' <param name="p_o_trans">Transaction à utiliser.</param>
        Public Overridable Sub Save(Optional p_o_trans As Transaction = Nothing)
            Save(True, p_o_trans)
        ...
        Public Overridable Sub Save(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            If Not IsNew And Not HasChanges Then Exit Sub
            If IsNew Then
                l_o_qry.SetKeyAuto(VITAL.VTL_ATTACHEMT.VTL_ATTACHEMT_ID)
            Else
                l_o_qry.AddTypedKey(VITAL.VTL_ATTACHEMT.VTL_ATTACHEMT_ID, ID)
            End If
            l_o_qry.AddValue(VITAL.VTL_ATTACHEMT.VTL_ATTACHEMT_NAME, TextSQL(Name))
            l_o_qry.AddValue(VITAL.VTL_ATTACHEMT.VTL_ATTACHEMT_CHEMIN, TextSQL(Chemin))
            l_o_qry.AddTypedValue(VITAL.VTL_ATTACHEMT.VTL_ATTACHEMT_CONSULT, Consult)
            If l_o_qry.ExecuteSave(Tables.VTL_ATTACHEMT, IsNew) > 0 Then
                HasChanges = False
                If IsNew Then SetAutoId(CInt(l_o_qry.NewAutoID))
                IsNew = False
        ...
        ''' <summary>
        ''' Supprime l'enregistrement de la table VTL_ATTACHEMT.
        ''' </summary>
        ''' <param name="p_o_trans">Transaction à utiliser.</param>
        Public Overridable Sub Delete(Optional p_o_trans As Transaction = Nothing)
            Delete(True, p_o_trans)
        ...
        Public Overridable Sub Delete(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            l_o_qry.AddWhereIs(VITAL.VTL_ATTACHEMT.VTL_ATTACHEMT_ID, ID)
            l_o_qry.ExecuteDelete(Tables.VTL_ATTACHEMT)
            CacheUpdate(True)
        End Sub
...
#Region "Cache"
        ...
        ''' </summary>
        ''' <param name="p_o_trans">La transaction à utiliser</param>
        ''' <param name="p_b_force">Objet de la classe Attachement.</param>
        Public Shared ReadOnly Property CacheDt(Optional p_o_trans As transaction = Nothing, Optional p_b_force As Boolean = False) As Datatable
            Get
                SyncLock m_o_cacheLock
                    If m_o_cacheDt Is Nothing Or p_b_force Then
                        m_o_cacheDt = Nothing
                        Dim l_o_qry As Query = VITAL.Attachement.GetAll(p_o_trans)
                        m_o_cacheDt = l_o_qry.GetDT
                        Dim l_o_pkColumns As New List(Of DataColumn)
                        l_o_pkColumns.add(m_o_cacheDt.Columns(VITAL.VTL_ATTACHEMT.VTL_ATTACHEMT_ID))
                        m_o_cacheDt.PrimaryKey = l_o_pkColumns.ToArray
                        m_b_cacheHasChanges = False
                    End If
                    Return m_o_cacheDt
        ...
        Private Shared Function CacheDtKey(p_o_object As VITAL.Attachement) As String
            Dim l_s_key As New System.Text.StringBuilder
            If l_s_key.Length <> 0 Then l_s_key.Append(" AND ")
            l_s_key.Append("VTL_ATTACHEMT_ID = " + p_o_object.ID.ToString())
            Return l_s_key.ToString()
        End Function
        ...
        ''' Permet de constuire le select représentant la clé primaire pour le cache datatable
        ''' </summary>
        Private Shared Function CacheDtKeyFind(p_o_object As VITAL.Attachement) As object()
            Dim l_o_pkColumns As New List(Of Object)
            l_o_pkColumns.add(p_o_object.ID)
            Return l_o_pkColumns.ToArray
        End Function
        ...
        Private Sub CacheUpdateDt(p_b_delete As Boolean)
            If Not m_o_cacheDt Is Nothing Then
                Dim l_o_dr As DataRow = m_o_cacheDt.Rows.Find(CacheDtKeyFind(CType(Me,VITAL.Attachement)))
...
#Region "ConseilDietetique - ConseilDietetique"
    ...
    <Serializable()> _
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Modeler", "1.4")> _
    Public MustInherit Class ConseilDietetique
        Inherits Raw.ConseilDietetique(Of VITAL.ConseilDietetique)
...
#Region "Méthodes publiques"
        ...
        Public Shared Function GetAll(Optional p_o_trans As Transaction = Nothing) As Query
            ...
            l_o_qry.AddFrom(Tables.VTL_CNSLDIET)
            Return l_o_qry
        End Function
        ...
        Friend Shared Function FindDR(p_i_iD As Integer, Optional p_o_trans As Transaction = Nothing) As DataRow
            ...
            Else
                Dim l_o_qry As Query = GetAll(p_o_trans)
                l_o_qry.AddWhereIs(VITAL.VTL_CNSLDIET.CNSLDIET_ID, p_i_iD)
                Return l_o_qry.GetFirstRow()
            End If
        End Function

        ''' <summary>
        ''' Chargement des informations à partir la table VTL_CNSLDIET.
        ''' </summary>
        ''' <param name="p_i_iD">ID.</param>
        ''' <param name="p_o_trans">Transaction à utiliser.</param>
        Public Overloads Sub Load(p_i_iD As Integer, Optional p_o_trans As Transaction = Nothing)
        ...
        ''' <summary>
        ''' Chargement des informations à partir de la table VTL_CNSLDIET.
        ''' </summary>
        ''' <param name="p_o_row">Enregistrement.</param>
        Public Overrides Sub Load(p_o_row As DataRow)
            MyBase.Load(p_o_row)
        ...
        ''' <summary>
        ''' Enregistrer les informations dans la table VTL_CNSLDIET.
        ''' </summary>
        ''' <param name="p_o_trans">Transaction à utiliser.</param>
        Public Overridable Sub Save(Optional p_o_trans As Transaction = Nothing)
            Save(True, p_o_trans)
        ...
        Public Overridable Sub Save(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            If Not IsNew And Not HasChanges Then Exit Sub
            If IsNew Then
                l_o_qry.SetKeyAuto(VITAL.VTL_CNSLDIET.CNSLDIET_ID)
            Else
                l_o_qry.AddTypedKey(VITAL.VTL_CNSLDIET.CNSLDIET_ID, ID)
            End If
            l_o_qry.AddValue(VITAL.VTL_CNSLDIET.CNSLDIET_CONTENU, TextSQL(Contenu))
            l_o_qry.AddTypedValue(VITAL.VTL_CNSLDIET.CNSLDIET_ID_ANIMAL, Id_animal)
            l_o_qry.AddTypedValue(VITAL.VTL_CNSLDIET.CNSLDIET_DATE, [Date])
            If l_o_qry.ExecuteSave(Tables.VTL_CNSLDIET, IsNew) > 0 Then
                HasChanges = False
                If IsNew Then SetAutoId(CInt(l_o_qry.NewAutoID))
                IsNew = False
        ...
        ''' <summary>
        ''' Supprime l'enregistrement de la table VTL_CNSLDIET.
        ''' </summary>
        ''' <param name="p_o_trans">Transaction à utiliser.</param>
        Public Overridable Sub Delete(Optional p_o_trans As Transaction = Nothing)
            Delete(True, p_o_trans)
        ...
        Public Overridable Sub Delete(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            l_o_qry.AddWhereIs(VITAL.VTL_CNSLDIET.CNSLDIET_ID, ID)
            l_o_qry.ExecuteDelete(Tables.VTL_CNSLDIET)
            CacheUpdate(True)
        End Sub
...
#Region "Cache"
        ...
        ''' </summary>
        ''' <param name="p_o_trans">La transaction à utiliser</param>
        ''' <param name="p_b_force">Objet de la classe ConseilDietetique.</param>
        Public Shared ReadOnly Property CacheDt(Optional p_o_trans As transaction = Nothing, Optional p_b_force As Boolean = False) As Datatable
            Get
                SyncLock m_o_cacheLock
                    If m_o_cacheDt Is Nothing Or p_b_force Then
                        m_o_cacheDt = Nothing
                        Dim l_o_qry As Query = VITAL.ConseilDietetique.GetAll(p_o_trans)
                        m_o_cacheDt = l_o_qry.GetDT
                        Dim l_o_pkColumns As New List(Of DataColumn)
                        l_o_pkColumns.add(m_o_cacheDt.Columns(VITAL.VTL_CNSLDIET.CNSLDIET_ID))
                        m_o_cacheDt.PrimaryKey = l_o_pkColumns.ToArray
                        m_b_cacheHasChanges = False
                    End If
                    Return m_o_cacheDt
        ...
        Private Shared Function CacheDtKey(p_o_object As VITAL.ConseilDietetique) As String
            Dim l_s_key As New System.Text.StringBuilder
            If l_s_key.Length <> 0 Then l_s_key.Append(" AND ")
            l_s_key.Append("CNSLDIET_ID = " + p_o_object.ID.ToString())
            Return l_s_key.ToString()
        End Function
        ...
        ''' Permet de constuire le select représentant la clé primaire pour le cache datatable
        ''' </summary>
        Private Shared Function CacheDtKeyFind(p_o_object As VITAL.ConseilDietetique) As object()
            Dim l_o_pkColumns As New List(Of Object)
            l_o_pkColumns.add(p_o_object.ID)
            Return l_o_pkColumns.ToArray
        End Function
        ...
        Private Sub CacheUpdateDt(p_b_delete As Boolean)
            If Not m_o_cacheDt Is Nothing Then
                Dim l_o_dr As DataRow = m_o_cacheDt.Rows.Find(CacheDtKeyFind(CType(Me,VITAL.ConseilDietetique)))
...
#Region "Méthodes publiques"
        ...
        Public Overridable Sub Save(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            l_o_qry.AddTypedValue(VITAL.VTL_CONTRAT.VTL_CONTRAT_TXREMB, TxRemb)
...
#Region "Méthodes publiques"
        ...
        Public Overridable Sub Save(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            l_o_qry.AddTypedValue(VITAL.VTL_MEDICAMENT.VTL_MEDICAMENT_DUREE_MOYENNE_JOUR, DureeMoyenneDuTraitement)
            l_o_qry.AddTypedValue(VITAL.VTL_MEDICAMENT.VTL_MEDICAMENT_PROPRIOCANDO, AdministrableParProprietaires)
...
#Region "Remboursement - Remboursement"
    ...
    <Serializable()> _
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Modeler", "1.4")> _
    Public MustInherit Class Remboursement
        Inherits Raw.Remboursement(Of VITAL.Remboursement)
...
#Region "Méthodes publiques"
        ...
        Public Shared Function GetAll(Optional p_o_trans As Transaction = Nothing) As Query
            ...
            l_o_qry.AddFrom(Tables.VTL_REMBOURSMT)
            Return l_o_qry
        End Function
        ...
        Friend Shared Function FindDR(p_i_iD As Integer, Optional p_o_trans As Transaction = Nothing) As DataRow
            ...
            Else
                Dim l_o_qry As Query = GetAll(p_o_trans)
                l_o_qry.AddWhereIs(VITAL.VTL_REMBOURSMT.VTL_REMBOURSMT_ID, p_i_iD)
                Return l_o_qry.GetFirstRow()
            End If
        End Function

        ''' <summary>
        ''' Chargement des informations à partir la table VTL_REMBOURSMT.
        ''' </summary>
        ''' <param name="p_i_iD">ID.</param>
        ''' <param name="p_o_trans">Transaction à utiliser.</param>
        Public Overloads Sub Load(p_i_iD As Integer, Optional p_o_trans As Transaction = Nothing)
        ...
        ''' <summary>
        ''' Chargement des informations à partir de la table VTL_REMBOURSMT.
        ''' </summary>
        ''' <param name="p_o_row">Enregistrement.</param>
        Public Overrides Sub Load(p_o_row As DataRow)
            MyBase.Load(p_o_row)
        ...
        ''' <summary>
        ''' Enregistrer les informations dans la table VTL_REMBOURSMT.
        ''' </summary>
        ''' <param name="p_o_trans">Transaction à utiliser.</param>
        Public Overridable Sub Save(Optional p_o_trans As Transaction = Nothing)
            Save(True, p_o_trans)
        ...
        Public Overridable Sub Save(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            If Not IsNew And Not HasChanges Then Exit Sub
            If IsNew Then
                l_o_qry.SetKeyAuto(VITAL.VTL_REMBOURSMT.VTL_REMBOURSMT_ID)
            Else
                l_o_qry.AddTypedKey(VITAL.VTL_REMBOURSMT.VTL_REMBOURSMT_ID, ID)
            End If
            l_o_qry.AddValue(VITAL.VTL_REMBOURSMT.VTL_REMBOURSMT_DATE, DB.SqlDateTime([Date]))
            l_o_qry.AddValue(VITAL.VTL_REMBOURSMT.VTL_REMBOURSMT_CONSULT, NullIfValue(Consult, 0))
            l_o_qry.AddValue(VITAL.VTL_REMBOURSMT.VTL_REMBOURSMT_CONTRAT, NullIfValue(Contrat, 0))
            l_o_qry.AddTypedValue(VITAL.VTL_REMBOURSMT.VTL_REMBOURSMT_MONTANT, Montant)
            l_o_qry.AddTypedValue(VITAL.VTL_REMBOURSMT.VTL_REMBOURSMT_STATUT, Statut)
            If l_o_qry.ExecuteSave(Tables.VTL_REMBOURSMT, IsNew) > 0 Then
                HasChanges = False
                If IsNew Then SetAutoId(CInt(l_o_qry.NewAutoID))
                IsNew = False
        ...
        ''' <summary>
        ''' Supprime l'enregistrement de la table VTL_REMBOURSMT.
        ''' </summary>
        ''' <param name="p_o_trans">Transaction à utiliser.</param>
        Public Overridable Sub Delete(Optional p_o_trans As Transaction = Nothing)
            Delete(True, p_o_trans)
        ...
        Public Overridable Sub Delete(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            l_o_qry.AddWhereIs(VITAL.VTL_REMBOURSMT.VTL_REMBOURSMT_ID, ID)
            l_o_qry.ExecuteDelete(Tables.VTL_REMBOURSMT)
            CacheUpdate(True)
        End Sub
...
#Region "Cache"
        ...
        ''' </summary>
        ''' <param name="p_o_trans">La transaction à utiliser</param>
        ''' <param name="p_b_force">Objet de la classe Remboursement.</param>
        Public Shared ReadOnly Property CacheDt(Optional p_o_trans As transaction = Nothing, Optional p_b_force As Boolean = False) As Datatable
            Get
                SyncLock m_o_cacheLock
                    If m_o_cacheDt Is Nothing Or p_b_force Then
                        m_o_cacheDt = Nothing
                        Dim l_o_qry As Query = VITAL.Remboursement.GetAll(p_o_trans)
                        m_o_cacheDt = l_o_qry.GetDT
                        Dim l_o_pkColumns As New List(Of DataColumn)
                        l_o_pkColumns.add(m_o_cacheDt.Columns(VITAL.VTL_REMBOURSMT.VTL_REMBOURSMT_ID))
                        m_o_cacheDt.PrimaryKey = l_o_pkColumns.ToArray
                        m_b_cacheHasChanges = False
                    End If
                    Return m_o_cacheDt
        ...
        Private Shared Function CacheDtKey(p_o_object As VITAL.Remboursement) As String
            Dim l_s_key As New System.Text.StringBuilder
            If l_s_key.Length <> 0 Then l_s_key.Append(" AND ")
            l_s_key.Append("VTL_REMBOURSMT_ID = " + p_o_object.ID.ToString())
            Return l_s_key.ToString()
        End Function
        ...
        ''' Permet de constuire le select représentant la clé primaire pour le cache datatable
        ''' </summary>
        Private Shared Function CacheDtKeyFind(p_o_object As VITAL.Remboursement) As object()
            Dim l_o_pkColumns As New List(Of Object)
            l_o_pkColumns.add(p_o_object.ID)
            Return l_o_pkColumns.ToArray
        End Function
        ...
        Private Sub CacheUpdateDt(p_b_delete As Boolean)
            If Not m_o_cacheDt Is Nothing Then
                Dim l_o_dr As DataRow = m_o_cacheDt.Rows.Find(CacheDtKeyFind(CType(Me,VITAL.Remboursement)))
...
#Region "Statut - Statut"
    ...
    <Serializable()> _
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Modeler", "1.4")> _
    Public MustInherit Class Statut
        Inherits Raw.Statut(Of VITAL.Statut)
...
#Region "Méthodes publiques"
        ...
        Public Shared Function GetAll(Optional p_o_trans As Transaction = Nothing) As Query
            ...
            l_o_qry.AddFrom(Tables.VTL_STATUT)
            Return l_o_qry
        End Function
        ...
        Friend Shared Function FindDR(p_i_iD As Integer, Optional p_o_trans As Transaction = Nothing) As DataRow
            ...
            Else
                Dim l_o_qry As Query = GetAll(p_o_trans)
                l_o_qry.AddWhereIs(VITAL.VTL_STATUT.VTL_STATUT_ID, p_i_iD)
                Return l_o_qry.GetFirstRow()
            End If
        End Function

        ''' <summary>
        ''' Chargement des informations à partir la table VTL_STATUT.
        ''' </summary>
        ''' <param name="p_i_iD">ID.</param>
        ''' <param name="p_o_trans">Transaction à utiliser.</param>
        Public Overloads Sub Load(p_i_iD As Integer, Optional p_o_trans As Transaction = Nothing)
        ...
        ''' <summary>
        ''' Chargement des informations à partir de la table VTL_STATUT.
        ''' </summary>
        ''' <param name="p_o_row">Enregistrement.</param>
        Public Overrides Sub Load(p_o_row As DataRow)
            MyBase.Load(p_o_row)
        ...
        ''' <summary>
        ''' Enregistrer les informations dans la table VTL_STATUT.
        ''' </summary>
        ''' <param name="p_o_trans">Transaction à utiliser.</param>
        Public Overridable Sub Save(Optional p_o_trans As Transaction = Nothing)
            Save(True, p_o_trans)
        ...
        Public Overridable Sub Save(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            If Not IsNew And Not HasChanges Then Exit Sub
            If IsNew Then
                l_o_qry.SetKeyAuto(VITAL.VTL_STATUT.VTL_STATUT_ID)
            Else
                l_o_qry.AddTypedKey(VITAL.VTL_STATUT.VTL_STATUT_ID, ID)
            End If
            l_o_qry.AddValue(VITAL.VTL_STATUT.VTL_STATUT_NAME, TextSQL(Name))
            If l_o_qry.ExecuteSave(Tables.VTL_STATUT, IsNew) > 0 Then
                HasChanges = False
                If IsNew Then SetAutoId(CInt(l_o_qry.NewAutoID))
                IsNew = False
        ...
        ''' <summary>
        ''' Supprime l'enregistrement de la table VTL_STATUT.
        ''' </summary>
        ''' <param name="p_o_trans">Transaction à utiliser.</param>
        Public Overridable Sub Delete(Optional p_o_trans As Transaction = Nothing)
            Delete(True, p_o_trans)
        ...
        Public Overridable Sub Delete(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            l_o_qry.AddWhereIs(VITAL.VTL_STATUT.VTL_STATUT_ID, ID)
            l_o_qry.ExecuteDelete(Tables.VTL_STATUT)
            CacheUpdate(True)
        End Sub
...
#Region "Cache"
        ...
        ''' </summary>
        ''' <param name="p_o_trans">La transaction à utiliser</param>
        ''' <param name="p_b_force">Objet de la classe Statut.</param>
        Public Shared ReadOnly Property CacheDt(Optional p_o_trans As transaction = Nothing, Optional p_b_force As Boolean = False) As Datatable
            Get
                SyncLock m_o_cacheLock
                    If m_o_cacheDt Is Nothing Or p_b_force Then
                        m_o_cacheDt = Nothing
                        Dim l_o_qry As Query = VITAL.Statut.GetAll(p_o_trans)
                        m_o_cacheDt = l_o_qry.GetDT
                        Dim l_o_pkColumns As New List(Of DataColumn)
                        l_o_pkColumns.add(m_o_cacheDt.Columns(VITAL.VTL_STATUT.VTL_STATUT_ID))
                        m_o_cacheDt.PrimaryKey = l_o_pkColumns.ToArray
                        m_b_cacheHasChanges = False
                    End If
                    Return m_o_cacheDt
        ...
        Private Shared Function CacheDtKey(p_o_object As VITAL.Statut) As String
            Dim l_s_key As New System.Text.StringBuilder
            If l_s_key.Length <> 0 Then l_s_key.Append(" AND ")
            l_s_key.Append("VTL_STATUT_ID = " + p_o_object.ID.ToString())
            Return l_s_key.ToString()
        End Function
        ...
        ''' Permet de constuire le select représentant la clé primaire pour le cache datatable
        ''' </summary>
        Private Shared Function CacheDtKeyFind(p_o_object As VITAL.Statut) As object()
            Dim l_o_pkColumns As New List(Of Object)
            l_o_pkColumns.add(p_o_object.ID)
            Return l_o_pkColumns.ToArray
        End Function
        ...
        Private Sub CacheUpdateDt(p_b_delete As Boolean)
            If Not m_o_cacheDt Is Nothing Then
                Dim l_o_dr As DataRow = m_o_cacheDt.Rows.Find(CacheDtKeyFind(CType(Me,VITAL.Statut)))
...
#Region "Méthodes publiques"
        ...
        Public Overridable Sub Save(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            l_o_qry.AddValue(VITAL.VTL_TRAITEMENT_MEDICAMENT.VTL_TRAITEMENT_MEDICAMENT_POSOLOGIE, TextSQL(Posologie))
...
#Region "Méthodes publiques"
        ...
        Public Overridable Sub Save(p_b_saveHisto As Boolean, Optional p_o_trans As Transaction = Nothing)
            ...
            l_o_qry.AddTypedValue(VITAL.VTL_VACCIN.VTL_VACCIN_TOP_PERIODIQUE, VaccinPeriodique)
            l_o_qry.AddTypedValue(VITAL.VTL_VACCIN.VTL_VACCIN_PERIODE_MOIS, MoisPeriode)
            l_o_qry.AddTypedValue(VITAL.VTL_VACCIN.VTL_VACCIN_TOP_RECOMMANDATION, Recommande)

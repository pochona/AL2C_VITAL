...
GO
-- "Suppression de la clef etrangere de la table VTL_TRAITREMENT vers la table VTL_ANIMAL"
IF EXISTS (SELECT * FROM sys.objects WHERE name = N'VTL_TRAITREMENT_ID_ANIMAL_VTL_ANIMAL_FK' AND type in (N'F'))
ALTER TABLE VTL_TRAITREMENT DROP CONSTRAINT VTL_TRAITREMENT_ID_ANIMAL_VTL_ANIMAL_FK;
GO
...
GO
-- "Suppression de la clef etrangere de la table VTL_ANIMAL vers la table VTL_PROPRIETAIRE"
IF EXISTS (SELECT * FROM sys.objects WHERE name = N'VTL_ANIMAL_ID_PROP_VTL_PROPRIETAIRE_FK' AND type in (N'F'))
ALTER TABLE VTL_ANIMAL DROP CONSTRAINT VTL_ANIMAL_ID_PROP_VTL_PROPRIETAIRE_FK;
GO
